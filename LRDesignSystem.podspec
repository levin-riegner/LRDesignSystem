...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.4'
  s.summary          = 'A short description of LRDesignSystem.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Oxean2014/LRDesignSystem'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Oxean2014' => 'ileider@gmail.com' }
  s.source           = { :git => 'https://github.com/Oxean2014/LRDesignSystem.git', :tag => s.version.to_s }
